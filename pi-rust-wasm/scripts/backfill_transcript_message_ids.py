#!/usr/bin/env python3
"""Backfill top-level MessageEntry.id in a pi JSONL transcript (OpenAI-style message rows).
...
Usage:
  python3 scripts/backfill_transcript_message_ids.py ~/.pi_/agents/main/sessions/foo.jsonl
"""
