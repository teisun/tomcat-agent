...
10. **通俗易懂原则**：Agent 在编写计划、描述问题、解释技术方案、撰写文档时，须使用 **12 岁小孩也能看懂的语言**。具体要求：用短句、用比喻、避免连续堆砌术语；先用一两句大白话说清楚「这东西是什么、干什么用」，再展开技术细节。目的是让任何新加入的工程师或非技术背景的审阅者都能快速理解上下文，降低协作门槛。
