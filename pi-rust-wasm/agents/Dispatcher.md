...
制定计划时须遵循 [plan/PLAN_SPEC.md](./plan/PLAN_SPEC.md) 中的**内容要求**（含全部 **6** 个维度）、**质量标准**与**自检清单**；中小任务可先复制 [plan/PLAN_SKELETON.md](./plan/PLAN_SKELETON.md) 再按规范扩写，并参考 PLAN_SPEC 第四节中的完整案例索引。
