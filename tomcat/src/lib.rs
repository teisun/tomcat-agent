...
pub use core::{
    ...
    ModelCatalog, ModelEntry, ModelPrefs, ModelPrefsStore, NoopStore, PrimitiveExecutor,
...
pub use infra::{
    ...
    resolve_plugins_dir, resolve_project_resource_dir, resolve_sessions_dir, resolve_tmp_dir,
    ...
    AuditRecorder, AuditStore, CheckpointConfig, ConnectorConfig, ContextConfig, DefaultEventBus,
