    ...
    WorkspaceState {
        read_write: vec![
            WorkspaceRootDescriptor {
                path: "/Users/yan/.tomcat/workspace-main".into(),
        ...
        read_only: vec![WorkspaceRootDescriptor {
            path: "/Users/yan/.tomcat/agents/main/sessions".into(),
...
fn workspace_state_section_renders_read_only_and_agent_dir() {
    ...
    assert!(s.contains("/Users/yan/.tomcat/agents/main/sessions"));
...
fn workspace_state_section_mentions_config_tools() {
    ...
    assert!(s.contains("DO NOT write to ~/.tomcat/tomcat.config.toml"));
}
...
fn build_system_prompt_with_state_includes_workspace_state() {
    ...
    assert!(prompt.contains("/Users/yan/.tomcat/workspace-main"));
