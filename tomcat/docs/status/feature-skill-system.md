...
| :--- | :--- | :--- | :--- | :--- |
| Spike | 2026-06-07 07:34 +0800 | DONE | feature/skill-system | — |
...
- [✓] **[P1]** `develop` 侧集成验收通过：fast-forward 合并后 clean-env `./scripts/run-integration-tests.sh all` 与显式 `./scripts/run-integration-tests.sh integration-wasm` 通过，任务卡已置 `DONE`
