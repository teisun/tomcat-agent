...
- [✓] **[P0]** 工程规范 #6–#10 写入提示词：#6/#7/#8 在 `core_identity.txt`、`planner.txt` 与两类 reviewer 模板逐字一致；#9/#10 落在 planner（多视角测试 / todos 宁多勿少）；UI(#8) 从工具 guidelines 迁出；单测 `standards_6_7_8_are_byte_identical_in_core_identity_planner_and_reviewers` 防漂移 @2026-07-16
