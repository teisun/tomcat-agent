...
| **T2-P1-019** | Tomcat VSCode Chat 扩展                        | `DONE` | Tom   | `feature/tomcat-vscode-extension`      | [tasks/T2-P1-019.md](./tasks/T2-P1-019.md) |
| **T2-P1-020** | Tomcat VSCode Chat 扩展 Phase 2                | `DONE` | Tom   | `feature/tomcat-vscode-extension`      | [tasks/T2-P1-020.md](./tasks/T2-P1-020.md) |
