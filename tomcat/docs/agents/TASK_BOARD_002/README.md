...
| **T2-P1-015** | 会话模式与多会话并发（claw/code + SessionRuntime） | `PENDING_INTEGRATION` | Jerry | `feature/optimize`                     | [tasks/T2-P1-015.md](./tasks/T2-P1-015.md) |
