...
| **T2-P1-018** | Agent Server 与 UI Gateway                    | `PENDING_INTEGRATION` | Spike | `feature/agent-server-ui-gateway`      | [tasks/T2-P1-018.md](./tasks/T2-P1-018.md) |
| **T2-P1-019** | Tomcat VSCode Chat 扩展                        | `TODO` | —     | `feature/tomcat-vscode-extension`      | [tasks/T2-P1-019.md](./tasks/T2-P1-019.md) |
