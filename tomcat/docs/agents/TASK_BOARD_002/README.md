...
| **T2-P1-016** | 插件系统（rquickjs 迁移）                           | `PENDING_INTEGRATION` | Tom   | `feature/plugin-function-surface`      | [tasks/T2-P1-016.md](./tasks/T2-P1-016.md) |
| **T2-P1-017** | PackageManager（统一包安装）                        | `PENDING_INTEGRATION` | Tom   | `feature/plugin-function-surface`      | [tasks/T2-P1-017.md](./tasks/T2-P1-017.md) |
