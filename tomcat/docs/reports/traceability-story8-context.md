...
|-------------------|----------|-----------------|
| `tomcat chat`、流式 | E2E-CLI-081 | `tests/cli_tests.rs`：`test_user_chat_non_interactive_with_prompt_flag` |
| `tomcat chat --resume`、JSONL 加载 | E2E-CLI-082 | `test_user_chat_resumes_last_session` |
| 多轮上下文 | E2E-CLI-083 | `test_user_chat_multi_turn_context_retained` |
| `tomcat session` 生命周期 | E2E-CLI-071～074 及 session 相关 `test_user_*` | `cli_tests.rs` |
