...
> 与 [`tools/reviewer.md` §4.1](./tools/reviewer.md#41-落地选型决策表) 同格式（**维度 / 取舍 / 拒因 / 说人话**；精简四列，完整审计见各工具 §4.1 七列主表）。覆盖 §14.3（多会话并发）+ §14.4（主-子编排）的全局选型；§14.6.1 internal subagent dispatch 与 §14.7 数据流图都是这张表的展开。
