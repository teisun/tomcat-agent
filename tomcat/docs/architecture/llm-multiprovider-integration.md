...
**任务与专文**：[`agents/TASK_BOARD_002/tasks/T2-P0-015.md`](../../agents/TASK_BOARD_002/tasks/T2-P0-015.md)；架构冻结版 [`docs/architecture/llm-files-upload-manager.md`](llm-files-upload-manager.md)。
